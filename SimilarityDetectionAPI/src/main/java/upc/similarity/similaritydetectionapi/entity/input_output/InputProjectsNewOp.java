...
@ApiModel(value = "InputProjectsNewOp", description = "OpenReqJson with requirements and projects")
public class InputProjectsNewOp implements Serializable {
